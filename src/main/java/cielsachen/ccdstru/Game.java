...
public class Game implements Runnable {
    ...
    /**
     * Gets an integer input, corresponding to a position's coordinates on the board, from a player through
     * {@code stdin}.
     * 
    ...
    /**
     * Runs the "game loop" responsible for keeping new player turns coming until the game is over. The winner will be
